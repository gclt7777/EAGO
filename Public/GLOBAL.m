...
%--------------------------------------------------------------------------
    ...
    properties(SetAccess = ?PROBLEM)
        ...
        %evaluation = 230000000;             % Maximum number of evaluations
    end
    ...
    methods
        ...
        %       P = obj.Initialization()
            ...
            Metrics1 = {@HV};
            Score1     = cellfun(@(S)GLOBAL.Metric(S,Population_2,obj.PF),Metrics1,'UniformOutput',false);
